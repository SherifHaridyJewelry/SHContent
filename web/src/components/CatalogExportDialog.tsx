    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="max-w-lg">
          ...
          <div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="export-scope-selected" className="font-normal cursor-pointer">
              ...
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="export-scope-filter" className="font-normal cursor-pointer">
              ...
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="export-scope-all" className="font-normal cursor-pointer">
        ...
        <DialogFooter>
          ...
          <Button disabled={submitting || countForScope === 0} onClick={handleExport}>
